...
test_that("Stick-breaking output has a multiple size of input", {
  # Such a multiple is required in `anpl_single`, where `x_prior` needs to be stacked
  # collated multiple times so the number of columns equals the number of stick breaks
