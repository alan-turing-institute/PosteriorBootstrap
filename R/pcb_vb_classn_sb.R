...
gplot2 <- ggplot2::ggplot(data=dplyr::filter(plot_df1, plot_df1$Method != 'Bayes', plot_df1$Method!='VB'), ggplot2::aes_string(x = 'beta21', y = 'beta22', colour = 'Method') ) +
...
ggplot2::ggsave(paste0('vb_logit_scatter_sb (bayesLogit=', use_bayes_logit, ').pdf'),plot=gplot2,width=14,height=5,units='cm')
